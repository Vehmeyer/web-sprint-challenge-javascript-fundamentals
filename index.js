...
const zooAnimals = [
  ...
  */
  ...
  function lowPopulationAnimals(list){
    const smallPopulation = list.filter(function(item){
      return item.population < 5;
    });
    return smallPopulation;
  };
  
  console.log('task2-3', lowPopulationAnimals(zooAnimals));
  ...
  */
  ...
  function USApop(list){
    const totalPop = list.reduce(function(acc, item){
      return acc + item.population;
    },0);
    return totalPop;
  };
  
  console.log('task2-4', USApop(zooAnimals));
